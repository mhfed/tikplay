...
const URL = 'https://www.tiktok.com/@longvumrcapcut01/video/7651599963360693512';
...
(async () => {
  ...
  await page.screenshot({ path: 'e2e/shot-desktop-active.png', fullPage: true });
  await page.click('.btn--play');
  await page.waitForTimeout(1300);
  await page.screenshot({ path: 'e2e/shot-desktop-playing.png', fullPage: true });
  await page.close();
